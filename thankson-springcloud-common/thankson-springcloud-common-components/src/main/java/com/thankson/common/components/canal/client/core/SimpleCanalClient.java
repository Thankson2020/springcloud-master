...
import com.thankson.common.components.canal.client.abstracts.AbstractCanalClient;
...
import com.thankson.common.components.canal.util.BeanUtil;
...
public class SimpleCanalClient extends AbstractCanalClient {
    ...
    private void initListeners() {
        ...
        //若是你喜欢通过注解的方式去监听的话。。
        Map<String, Object> listenerMap = BeanUtil.getBeansWithAnnotation(com.thankson.common.components.canal.annotation.CanalEventListener.class);
        //也放入 map
        if (listenerMap != null) {
